...
//     text: `Você solicitou a recuperação de senha para o site PETBOOK.COM. 
// Sua nova senha de acesso ao site é: ${newPassword}`,
    subject: `Redefinição de Senha - Petbook`,
    from: `Suporte Petbook <contatopetbook.etec@gmail.com>`,
    to: `${email}`,
    html: `
    <html>
      <body>
        <p>
          Você solicitou a recuperação de senha para o site PETBOOK.COM. 
          Sua nova senha de acesso ao site é: <h3>${newPassword}</h3>
